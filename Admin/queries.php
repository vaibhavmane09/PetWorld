...
?>
    ...
    <head>
        ...
        <title>PetWorld-Admin | Queries</title>
    ...
    <body>
        <div class="side-bar">
            ...
            <div class="item">
                ...
                <a class="item activeted" href="queries.php">
        ...
        <div class="main-content">
            ...
            <!-- ======================== queries table starts here... ======================== -->


            <div class="view-queries-container">
                ...
                <div class="view-queries">
                    ...
                    <table class="view-queries-table">

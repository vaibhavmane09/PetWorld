...
<body>
    ...
    <form action="" method="post" autocomplete="off" name="myForm" onsubmit="return changePassword()">
        <div class="wrapper">
            <div class="logo">
    ...
    if (isset($_POST['submit'])) {
        ...
        $cpass = $_POST['cpass'];
        if ($pass == $cpass) {
            $sql = "update users set pwd='$pass' where mobno='$mobno'";
            ...
            if ($res) {
                ...
                echo '</script>';
                header("refresh:2");
                // echo "<script> window.location='../user_login_signup.php';</script>";
                echo "<script> document.ready(window.setTimeout(window.location.href = '../user_login_signup.php',5000));
                </script>";
            } 
        }
        else {

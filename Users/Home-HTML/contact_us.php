...
?>
    ...
    <head>
        ...
        <title>ThePetWorld-User | Contact Us</title>
        <link rel="stylesheet" href="../CSS/Home-CSS/style.css">
        <link rel="stylesheet" href="../CSS/Home-CSS/contact_us.css">
        ...
        <section>
            <div class="ContactContainer">
                ...
                <div class="contactForm">
                    ...
                    <form class="formBox" action="#" autocomplete="off" method="post">
                        ...
                        <div class="inputBox w50">
                            <input type="tel" name="mobno" value="<?php echo $row['mobno']; ?>" required />
                        </div>
                        <div class="inputBox w100">
                            <textarea name="msg" placeholder="Leave A Note Here... " required=""></textarea>
                        </div>
                        <div class="inputBox w100">
                    ...
                    if (isset($_POST['contact'])) {
                        $conn = mysqli_connect("localhost", "root", "", "petworld"); {
                            ...
                            $insertquery = "insert into contactus values('$fname','$lname','$email','$mobno','$msg')";
